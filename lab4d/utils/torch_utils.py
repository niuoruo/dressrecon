...
def compute_gradients_sdf(fn, x, training=False, mode="numerical", eps=1e-3):
    """Modified from https://github.com/NVlabs/neuralangelo/blob/94390b64683c067c620d9e075224ccfe582647d0/projects/neuralangelo/utils/modules.py#L115"""
    x = x.detach()
    if mode == "analytical":
