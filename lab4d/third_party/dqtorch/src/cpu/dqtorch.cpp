...
void _standardize_quaternion_fw(const scalar_t *__restrict__ a, scalar_t *__restrict__ out) {
    if (a[0] < 0) {
        out[0] = -a[0];
        out[1] = -a[1];
        out[2] = -a[2];
...
template <typename scalar_t>
void _standardize_quaternion_bw(const scalar_t *__restrict__ out_grad, const scalar_t *__restrict__ a,
...
template <typename scalar_t>
void _quaternion_raw_multiply_fw(const scalar_t *__restrict__ a, const scalar_t *__restrict__ b,
...
template <typename scalar_t>
void _quaternion_raw_multiply_bw(const scalar_t *__restrict__ out_grad, const scalar_t *__restrict__ a,
...
template <typename scalar_t>
void _quaternion_multiply_fw(const scalar_t *__restrict__ a, const scalar_t *__restrict__ b, scalar_t *__restrict__ out, const uint32_t Da, const uint32_t Db) {
    scalar_t raw[4] = {};
...
template <typename scalar_t>
void _quaternion_multiply_bw(const scalar_t *__restrict__ out_grad, const scalar_t *__restrict__ a, const scalar_t *__restrict__ b, scalar_t *__restrict__ a_grad, scalar_t *__restrict__ b_grad, const uint32_t Da, const uint32_t Db) {
    scalar_t raw[4] = {};
    _quaternion_raw_multiply_fw<scalar_t>(a, b, raw, Da, Db, 4);
...
template <typename scalar_t>
void _quaternion_conjugate_fw(const scalar_t *__restrict__ a, scalar_t *__restrict__ out) {
    out[0] = a[0];
    out[1] = -a[1];
    out[2] = -a[2];
    out[3] = -a[3];
...
template <typename scalar_t>
void _quaternion_conjugate_bw(const scalar_t *__restrict__ out_grad, const scalar_t *__restrict__ a, scalar_t *__restrict__ a_grad) {
    a_grad[0] += out_grad[0];
    a_grad[1] += -out_grad[1];
    a_grad[2] += -out_grad[2];
    a_grad[3] += -out_grad[3];
...
template <typename scalar_t>
void _quaternion_apply_fw(const scalar_t *__restrict__ a, const scalar_t *__restrict__ b, scalar_t *__restrict__ out) {
    scalar_t raw[4] = {};
    scalar_t a_inv[4] = {};
...
template <typename scalar_t>
void _quaternion_apply_bw(const scalar_t *__restrict__ out_grad, const scalar_t *__restrict__ a, const scalar_t *__restrict__ b, scalar_t *__restrict__ a_grad, scalar_t *__restrict__ b_grad) {
    scalar_t raw[4] = {};
    scalar_t a_inv[4] = {};
    _quaternion_raw_multiply_fw<scalar_t>(a, b, raw, 4, 3, 4);
    _quaternion_conjugate_fw<scalar_t>(a, a_inv);
...
template <typename scalar_t>
void _quaternion_to_matrix_fw(const scalar_t *__restrict__ a, scalar_t *__restrict__ out) {
    scalar_t w = a[0];
    scalar_t x = a[1];
    scalar_t y = a[2];
    scalar_t z = a[3];
...
template <typename scalar_t>
void _quaternion_to_matrix_bw(const scalar_t *__restrict__ out_grad, const scalar_t *__restrict__ a,
                                         scalar_t *__restrict__ a_grad) {
    scalar_t w = a[0];
    scalar_t x = a[1];
    scalar_t y = a[2];
...
template <typename scalar_t>
void _matrix_to_raw_quaternion_fw(const scalar_t *__restrict__ a, scalar_t *__restrict__ out) {
    scalar_t a00 = a[0];
    scalar_t a01 = a[1];
    scalar_t a02 = a[2];
    scalar_t a10 = a[3];
...
template <typename scalar_t>
void _matrix_to_raw_quaternion_bw(const scalar_t *__restrict__ out_grad, const scalar_t *__restrict__ a,
                                         scalar_t *__restrict__ a_grad) {
...
template <typename scalar_t>
void _matrix_to_quaternion_fw(const scalar_t *__restrict__ a, scalar_t *__restrict__ out) {
    scalar_t raw[4] = {};
...
template <typename scalar_t>
void _matrix_to_quaternion_bw(const scalar_t *__restrict__ out_grad, const scalar_t *__restrict__ a, scalar_t *__restrict__ a_grad) {
    scalar_t raw[4] = {};
    _matrix_to_raw_quaternion_fw<scalar_t>(a, raw);
...
template <typename scalar_t>
void _axis_angle_to_quaternion_fw(const scalar_t *__restrict__ a, scalar_t *__restrict__ out) {
    scalar_t x = a[0];
    scalar_t y = a[1];
    scalar_t z = a[2];
...
template <typename scalar_t>
void _axis_angle_to_quaternion_bw(const scalar_t *__restrict__ out_grad, const scalar_t *__restrict__ a, scalar_t *__restrict__ a_grad) {
    scalar_t dw = out_grad[0];
    scalar_t dx = out_grad[1];
    scalar_t dy = out_grad[2];
    scalar_t dz = out_grad[3];
...
template <typename scalar_t>
void _quaternion_to_axis_angle_fw(const scalar_t *__restrict__ a, scalar_t *__restrict__ out) {
    scalar_t w = a[0];
    scalar_t x = a[1];
    scalar_t y = a[2];
    scalar_t z = a[3];
...
template <typename scalar_t>
void _quaternion_to_axis_angle_bw(const scalar_t *__restrict__ out_grad, const scalar_t *__restrict__ a, scalar_t *__restrict__ a_grad) {
...
template <typename scalar_t>
void _axis_angle_to_matrix_fw(const scalar_t *__restrict__ a, scalar_t *__restrict__ out) {
    scalar_t raw[4] = {};
...
template <typename scalar_t>
void _axis_angle_to_matrix_bw(const scalar_t *__restrict__ out_grad, const scalar_t *__restrict__ a, scalar_t *__restrict__ a_grad) {
    scalar_t raw[4] = {};
    _axis_angle_to_quaternion_fw<scalar_t>(a, raw);
...
template <typename scalar_t>
void _matrix_to_axis_angle_fw(const scalar_t *__restrict__ a, scalar_t *__restrict__ out) {
    scalar_t raw[4] = {};
...
template <typename scalar_t>
void _matrix_to_axis_angle_bw(const scalar_t *__restrict__ out_grad, const scalar_t *__restrict__ a, scalar_t *__restrict__ a_grad) {
    scalar_t raw[4] = {};
    _matrix_to_quaternion_fw<scalar_t>(a, raw);
...
template <typename scalar_t>
void _quaternion_translation_mul_fw(const scalar_t *__restrict__ a_q, const scalar_t *__restrict__ a_t, const scalar_t *__restrict__ b_q, const scalar_t *__restrict__ b_t, scalar_t *__restrict__ out_q, scalar_t *__restrict__ out_t) {
...
template <typename scalar_t>
void _quaternion_translation_mul_bw(const scalar_t *__restrict__ out_q_grad, const scalar_t *__restrict__ out_t_grad, const scalar_t *__restrict__ a_q, const scalar_t *__restrict__ a_t, const scalar_t *__restrict__ b_q, const scalar_t *__restrict__ b_t, scalar_t *__restrict__ a_q_grad, scalar_t *__restrict__ a_t_grad, scalar_t *__restrict__ b_q_grad, scalar_t *__restrict__ b_t_grad) {
...
template <typename scalar_t>
void _quaternion_translation_apply_fw(const scalar_t *__restrict__ a_q, const scalar_t *__restrict__ a_t, const scalar_t *__restrict__ b, scalar_t *__restrict__ out) {
...
template <typename scalar_t>
void _quaternion_translation_apply_bw(const scalar_t *__restrict__ out_grad, const scalar_t *__restrict__ a_q, const scalar_t *__restrict__ a_t, const scalar_t *__restrict__ b, scalar_t *__restrict__ a_q_grad, scalar_t *__restrict__ a_t_grad, scalar_t *__restrict__ b_grad) {
...
template <typename scalar_t>
void _quaternion_translation_inverse_fw(const scalar_t *__restrict__ a_q, const scalar_t *__restrict__ a_t, scalar_t *__restrict__ out_q, scalar_t *__restrict__ out_t) {
    scalar_t a_t_neg[3] = {};
    a_t_neg[0] = -a_t[0];
    a_t_neg[1] = -a_t[1];
    a_t_neg[2] = -a_t[2];
...
template <typename scalar_t>
void _quaternion_translation_inverse_bw(const scalar_t *__restrict__ out_q_grad, const scalar_t *__restrict__ out_t_grad, const scalar_t *__restrict__ a_q, const scalar_t *__restrict__ a_t, scalar_t *__restrict__ a_q_grad, scalar_t *__restrict__ a_t_grad) {
    scalar_t out_q[4] = {};
    scalar_t a_t_neg[3] = {};
    _quaternion_conjugate_fw<scalar_t>(a_q, out_q);
    a_t_neg[0] = -a_t[0];
...
template <typename scalar_t>
void _dual_quaternion_mul_fw(const scalar_t *__restrict__ a_r, const scalar_t *__restrict__ a_d, const scalar_t *__restrict__ b_r, const scalar_t *__restrict__ b_d, scalar_t *__restrict__ out_r, scalar_t *__restrict__ out_d) {
    scalar_t out_d2[4] = {};
...
template <typename scalar_t>
void _dual_quaternion_mul_bw(const scalar_t *__restrict__ out_r_grad, const scalar_t *__restrict__ out_d_grad, const scalar_t *__restrict__ a_r, const scalar_t *__restrict__ a_d, const scalar_t *__restrict__ b_r, const scalar_t *__restrict__ b_d, scalar_t *__restrict__ a_r_grad, scalar_t *__restrict__ a_d_grad, scalar_t *__restrict__ b_r_grad, scalar_t *__restrict__ b_d_grad) {
...
template <typename scalar_t>
void _dual_quaternion_to_quaternion_translation_fw(const scalar_t *__restrict__ a_r, const scalar_t *__restrict__ a_d, scalar_t *__restrict__ out_q, scalar_t *__restrict__ out_t);

template <typename scalar_t>
void _dual_quaternion_apply_fw(const scalar_t *__restrict__ a_r, const scalar_t *__restrict__ a_d, const scalar_t *__restrict__ b, scalar_t *__restrict__ out) {
    scalar_t a_q[4] = {};
    scalar_t a_t[3] = {};
...
template <typename scalar_t>
void _dual_quaternion_to_quaternion_translation_bw(const scalar_t *__restrict__ out_q_grad, const scalar_t *__restrict__ out_t_grad, const scalar_t *__restrict__ a_r, const scalar_t *__restrict__ a_d, scalar_t *__restrict__ a_r_grad, scalar_t *__restrict__ a_d_grad);

template <typename scalar_t>
void _dual_quaternion_apply_bw(const scalar_t *__restrict__ out_grad, const scalar_t *__restrict__ a_r, const scalar_t *__restrict__ a_d, const scalar_t *__restrict__ b, scalar_t *__restrict__ a_r_grad, scalar_t *__restrict__ a_d_grad, scalar_t *__restrict__ b_grad) {
    scalar_t a_q[4] = {};
    scalar_t a_t[3] = {};
    _dual_quaternion_to_quaternion_translation_fw<scalar_t>(a_r, a_d, a_q, a_t);
...
template <typename scalar_t>
void _dual_quaternion_q_conjugate_fw(const scalar_t *__restrict__ a_r, const scalar_t *__restrict__ a_d, scalar_t *__restrict__ out_r, scalar_t *__restrict__ out_d) {
...
template <typename scalar_t>
void _dual_quaternion_q_conjugate_bw(const scalar_t *__restrict__ out_r_grad, const scalar_t *__restrict__ out_d_grad, const scalar_t *__restrict__ a_r, const scalar_t *__restrict__ a_d, scalar_t *__restrict__ a_r_grad, scalar_t *__restrict__ a_d_grad) {
...
template <typename scalar_t>
void _dual_quaternion_d_conjugate_fw(const scalar_t *__restrict__ a_r, const scalar_t *__restrict__ a_d, scalar_t *__restrict__ out_r, scalar_t *__restrict__ out_d) {
    out_r[0] = a_r[0];
    out_r[1] = a_r[1];
    out_r[2] = a_r[2];
    out_r[3] = a_r[3];
...
template <typename scalar_t>
void _dual_quaternion_d_conjugate_bw(const scalar_t *__restrict__ out_r_grad, const scalar_t *__restrict__ out_d_grad, const scalar_t *__restrict__ a_r, const scalar_t *__restrict__ a_d, scalar_t *__restrict__ a_r_grad, scalar_t *__restrict__ a_d_grad) {
...
template <typename scalar_t>
void _dual_quaternion_3rd_conjugate_fw(const scalar_t *__restrict__ a_r, const scalar_t *__restrict__ a_d, scalar_t *__restrict__ out_r, scalar_t *__restrict__ out_d) {
    scalar_t raw_r[4] = {};
    scalar_t raw_d[4] = {};
...
template <typename scalar_t>
void _dual_quaternion_3rd_conjugate_bw(const scalar_t *__restrict__ out_r_grad, const scalar_t *__restrict__ out_d_grad, const scalar_t *__restrict__ a_r, const scalar_t *__restrict__ a_d, scalar_t *__restrict__ a_r_grad, scalar_t *__restrict__ a_d_grad) {
    scalar_t raw_r[4] = {};
    scalar_t raw_d[4] = {};
    _dual_quaternion_q_conjugate_fw<scalar_t>(a_r, a_d, raw_r, raw_d);
...
template <typename scalar_t>
void _dual_quaternion_norm_fw(const scalar_t *__restrict__ a_r, const scalar_t *__restrict__ a_d, scalar_t *__restrict__ out_r, scalar_t *__restrict__ out_d) {
    scalar_t a_inv_r[4] = {};
    scalar_t a_inv_d[4] = {};
...
template <typename scalar_t>
void _dual_quaternion_norm_bw(const scalar_t *__restrict__ out_r_grad, const scalar_t *__restrict__ out_d_grad, const scalar_t *__restrict__ a_r, const scalar_t *__restrict__ a_d, scalar_t *__restrict__ a_r_grad, scalar_t *__restrict__ a_d_grad) {
    scalar_t a_inv_r[4] = {};
    scalar_t a_inv_d[4] = {};
    _dual_quaternion_q_conjugate_fw<scalar_t>(a_r, a_d, a_inv_r, a_inv_d);
...
template <typename scalar_t>
void _quaternion_translation_to_dual_quaternion_fw(const scalar_t *__restrict__ a_q, const scalar_t *__restrict__ a_t, scalar_t *__restrict__ out_r, scalar_t *__restrict__ out_d) {
    scalar_t raw_d[4] = {};
    out_r[0] = a_q[0];
    out_r[1] = a_q[1];
    out_r[2] = a_q[2];
...
template <typename scalar_t>
void _quaternion_translation_to_dual_quaternion_bw(const scalar_t *__restrict__ out_r_grad, const scalar_t *__restrict__ out_d_grad, const scalar_t *__restrict__ a_q, const scalar_t *__restrict__ a_t, scalar_t *__restrict__ a_q_grad, scalar_t *__restrict__ a_t_grad) {
    scalar_t raw_d_grad[4] = {};
...
template <typename scalar_t>
void _quaternion_translation_to_se3_fw(const scalar_t *__restrict__ a_q, const scalar_t *__restrict__ a_t, scalar_t *__restrict__ out) {
    scalar_t rmat[9] = {};
...
template <typename scalar_t>
void _quaternion_translation_to_se3_bw(const scalar_t *__restrict__ out_grad, const scalar_t *__restrict__ a_q, const scalar_t *__restrict__ a_t, scalar_t *__restrict__ a_q_grad, scalar_t *__restrict__ a_t_grad) {
...
template <typename scalar_t>
void _se3_to_quaternion_translation_fw(const scalar_t *__restrict__ a, scalar_t *__restrict__ out_q, scalar_t *__restrict__ out_t) {
    scalar_t rmat[9] = {};
    rmat[0] = a[0];
    rmat[1] = a[1];
    rmat[2] = a[2];
...
template <typename scalar_t>
void _se3_to_quaternion_translation_bw(const scalar_t *__restrict__ out_q_grad, const scalar_t *__restrict__ out_t_grad, const scalar_t *__restrict__ a, scalar_t *__restrict__ a_grad) {
    scalar_t rmat[9] = {};
    rmat[0] = a[0];
    rmat[1] = a[1];
    rmat[2] = a[2];
...
template <typename scalar_t>
void _dual_quaternion_to_se3_fw(const scalar_t *__restrict__ a_r, const scalar_t *__restrict__ a_d, scalar_t *__restrict__ out) {
    scalar_t raw_r[4] = {};
    scalar_t raw_d[3] = {};
...
template <typename scalar_t>
void _dual_quaternion_to_se3_bw(const scalar_t *__restrict__ out_grad, const scalar_t *__restrict__ a_r, const scalar_t *__restrict__ a_d, scalar_t *__restrict__ a_r_grad, scalar_t *__restrict__ a_d_grad) {
    scalar_t a_q[4] = {};
    scalar_t a_t[3] = {};
    _dual_quaternion_to_quaternion_translation_fw<scalar_t>(a_r, a_d, a_q, a_t);
...
template <typename scalar_t>
void _se3_to_dual_quaternion_fw(const scalar_t *__restrict__ a, scalar_t *__restrict__ out_r, scalar_t *__restrict__ out_d) {
    scalar_t out_q[4] = {};
    scalar_t out_t[3] = {};
...
template <typename scalar_t>
void _se3_to_dual_quaternion_bw(const scalar_t *__restrict__ out_r_grad, const scalar_t *__restrict__ out_d_grad, const scalar_t *__restrict__ a, scalar_t *__restrict__ a_grad) {
    scalar_t out_q[4] = {};
    scalar_t out_t[3] = {};
    _se3_to_quaternion_translation_fw<scalar_t>(a, out_q, out_t);
...
template <typename scalar_t>
void kernel_standardize_quaternion_fw(const scalar_t *__restrict__ a, scalar_t *__restrict__ out,
                                                 const uint32_t B) {
...
void standardize_quaternion_fw(at::Tensor a, at::Tensor out, const uint32_t B) {
    CHECK_IS_CONTIGUOUS_FLOAT_CPU(a);
    CHECK_IS_CONTIGUOUS_FLOAT_CPU(out);

    AT_DISPATCH_FLOATING_TYPES_AND_HALF(
        a.scalar_type(), "standardize_quaternion_fw", ([&] { 
            kernel_standardize_quaternion_fw<scalar_t>(a.data_ptr<scalar_t>(), out.data_ptr<scalar_t>(), B);
            }));
}
...
template <typename scalar_t>
void kernel_standardize_quaternion_bw(const scalar_t *__restrict__ out_grad, const scalar_t *__restrict__ a,
...
void standardize_quaternion_bw(at::Tensor out_grad, at::Tensor a, at::Tensor a_grad, const uint32_t B) {
    CHECK_IS_CONTIGUOUS_FLOAT_CPU(out_grad);
    CHECK_IS_CONTIGUOUS_FLOAT_CPU(a);
    CHECK_IS_CONTIGUOUS_FLOAT_CPU(a_grad);

    AT_DISPATCH_FLOATING_TYPES_AND_HALF(a.scalar_type(), "standardize_quaternion_bw", ([&] {
        kernel_standardize_quaternion_bw<scalar_t>(out_grad.data_ptr<scalar_t>(), a.data_ptr<scalar_t>(), a_grad.data_ptr<scalar_t>(), B);
    }));
}
...
template <typename scalar_t>
void kernel_quaternion_raw_multiply_fw(const scalar_t *__restrict__ a, const scalar_t *__restrict__ b,
...
void quaternion_raw_multiply_fw(at::Tensor a, at::Tensor b, at::Tensor out, const uint32_t B, const uint32_t Da,
                                const uint32_t Db) {
    CHECK_IS_CONTIGUOUS_FLOAT_CPU(a);
    CHECK_IS_CONTIGUOUS_FLOAT_CPU(b);
    CHECK_IS_CONTIGUOUS_FLOAT_CPU(out);

    AT_DISPATCH_FLOATING_TYPES_AND_HALF(a.scalar_type(), "quaternion_raw_multiply_fw", ([&] {
        kernel_quaternion_raw_multiply_fw<scalar_t>(a.data_ptr<scalar_t>(), b.data_ptr<scalar_t>(), out.data_ptr<scalar_t>(), B, Da, Db);
    }));
}
...
template <typename scalar_t>
void kernel_quaternion_raw_multiply_bw(const scalar_t *__restrict__ out_grad,
...
void quaternion_raw_multiply_bw(at::Tensor out_grad, at::Tensor a, at::Tensor b, at::Tensor a_grad,
    ...
    CHECK_IS_CONTIGUOUS_FLOAT_CPU(b);
    CHECK_IS_CONTIGUOUS_FLOAT_CPU(a_grad);
    CHECK_IS_CONTIGUOUS_FLOAT_CPU(b_grad);

    AT_DISPATCH_FLOATING_TYPES_AND_HALF(a.scalar_type(), "quaternion_raw_multiply_bw", ([&] {
        kernel_quaternion_raw_multiply_bw<scalar_t>(out_grad.data_ptr<scalar_t>(), a.data_ptr<scalar_t>(), b.data_ptr<scalar_t>(), a_grad.data_ptr<scalar_t>(), b_grad.data_ptr<scalar_t>(), B, Da, Db);
    }));
}
...
template <typename scalar_t>
void kernel_quaternion_multiply_fw(const scalar_t *__restrict__ a, const scalar_t *__restrict__ b, scalar_t *__restrict__ out,
...
void quaternion_multiply_fw(at::Tensor a, at::Tensor b, at::Tensor out, const uint32_t B, const uint32_t Da, const uint32_t Db) {
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(a.scalar_type(), "quaternion_multiply_fw", ([&] {
        kernel_quaternion_multiply_fw<scalar_t>(a.data_ptr<scalar_t>(), b.data_ptr<scalar_t>(), out.data_ptr<scalar_t>(), B, Da, Db);
    }));
}
...
template <typename scalar_t>
void kernel_quaternion_multiply_bw(const scalar_t *__restrict__ out_grad, const scalar_t *__restrict__ a, const scalar_t *__restrict__ b,
...
void quaternion_multiply_bw(at::Tensor out_grad, at::Tensor a, at::Tensor b, at::Tensor a_grad, at::Tensor b_grad, const uint32_t B, const uint32_t Da, const uint32_t Db) {
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(a.scalar_type(), "quaternion_multiply_bw", ([&] {
        kernel_quaternion_multiply_bw<scalar_t>(out_grad.data_ptr<scalar_t>(), a.data_ptr<scalar_t>(), b.data_ptr<scalar_t>(), a_grad.data_ptr<scalar_t>(), b_grad.data_ptr<scalar_t>(), B, Da, Db);
    }));
}
...
template <typename scalar_t>
void kernel_quaternion_conjugate_fw(const scalar_t *__restrict__ a, scalar_t *__restrict__ out,
                                                 const uint32_t B) {
    for (uint32_t i = 0; i < B; i++) {
...
void quaternion_conjugate_fw(at::Tensor a, at::Tensor out, const uint32_t B) {
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(a.scalar_type(), "quaternion_conjugate_fw", ([&] {
        kernel_quaternion_conjugate_fw<scalar_t>(a.data_ptr<scalar_t>(), out.data_ptr<scalar_t>(), B);
    }));
}
...
template <typename scalar_t>
void kernel_quaternion_conjugate_bw(const scalar_t *__restrict__ out_grad, const scalar_t *__restrict__ a,
                                                 scalar_t *__restrict__ a_grad, const uint32_t B) {
    for (uint32_t i = 0; i < B; i++) {
...
void quaternion_conjugate_bw(at::Tensor out_grad, at::Tensor a, at::Tensor a_grad, const uint32_t B) {
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(a.scalar_type(), "quaternion_conjugate_bw", ([&] {
        kernel_quaternion_conjugate_bw<scalar_t>(out_grad.data_ptr<scalar_t>(), a.data_ptr<scalar_t>(), a_grad.data_ptr<scalar_t>(), B);
    }));
}
...
template <typename scalar_t>
void kernel_quaternion_apply_fw(const scalar_t *__restrict__ a, const scalar_t *__restrict__ b, scalar_t *__restrict__ out,
                                                 const uint32_t B) {
    for (uint32_t i = 0; i < B; i++) {
...
void quaternion_apply_fw(at::Tensor a, at::Tensor b, at::Tensor out, const uint32_t B) {
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(a.scalar_type(), "quaternion_apply_fw", ([&] {
        kernel_quaternion_apply_fw<scalar_t>(a.data_ptr<scalar_t>(), b.data_ptr<scalar_t>(), out.data_ptr<scalar_t>(), B);
    }));
}
...
template <typename scalar_t>
void kernel_quaternion_apply_bw(const scalar_t *__restrict__ out_grad, const scalar_t *__restrict__ a, const scalar_t *__restrict__ b,
...
void quaternion_apply_bw(at::Tensor out_grad, at::Tensor a, at::Tensor b, at::Tensor a_grad, at::Tensor b_grad, const uint32_t B) {
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(a.scalar_type(), "quaternion_apply_bw", ([&] {
        kernel_quaternion_apply_bw<scalar_t>(out_grad.data_ptr<scalar_t>(), a.data_ptr<scalar_t>(), b.data_ptr<scalar_t>(), a_grad.data_ptr<scalar_t>(), b_grad.data_ptr<scalar_t>(), B);
    }));
}
...
template <typename scalar_t>
void kernel_quaternion_to_matrix_fw(const scalar_t *__restrict__ a, scalar_t *__restrict__ out,
                                                 const uint32_t B) {
    for (uint32_t i = 0; i < B; i++) {
...
void quaternion_to_matrix_fw(at::Tensor a, at::Tensor out, const uint32_t B) {
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(a.scalar_type(), "quaternion_to_matrix_fw", ([&] {
        kernel_quaternion_to_matrix_fw<scalar_t>(a.data_ptr<scalar_t>(), out.data_ptr<scalar_t>(), B);
    }));
}
...
template <typename scalar_t>
void kernel_quaternion_to_matrix_bw(const scalar_t *__restrict__ out_grad, const scalar_t *__restrict__ a,
                                                 scalar_t *__restrict__ a_grad, const uint32_t B) {
    for (uint32_t i = 0; i < B; i++) {
...
void quaternion_to_matrix_bw(at::Tensor out_grad, at::Tensor a, at::Tensor a_grad, const uint32_t B) {
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(a.scalar_type(), "quaternion_to_matrix_bw", ([&] {
        kernel_quaternion_to_matrix_bw<scalar_t>(out_grad.data_ptr<scalar_t>(), a.data_ptr<scalar_t>(), a_grad.data_ptr<scalar_t>(), B);
    }));
}
...
template <typename scalar_t>
void kernel_matrix_to_raw_quaternion_fw(const scalar_t *__restrict__ a, scalar_t *__restrict__ out,
                                                 const uint32_t B) {
    for (uint32_t i = 0; i < B; i++) {
...
void matrix_to_raw_quaternion_fw(at::Tensor a, at::Tensor out, const uint32_t B) {
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(a.scalar_type(), "matrix_to_raw_quaternion_fw", ([&] {
        kernel_matrix_to_raw_quaternion_fw<scalar_t>(a.data_ptr<scalar_t>(), out.data_ptr<scalar_t>(), B);
    }));
}
...
template <typename scalar_t>
void kernel_matrix_to_raw_quaternion_bw(const scalar_t *__restrict__ out_grad, const scalar_t *__restrict__ a,
                                                 scalar_t *__restrict__ a_grad, const uint32_t B) {
    for (uint32_t i = 0; i < B; i++) {
...
void matrix_to_raw_quaternion_bw(at::Tensor out_grad, at::Tensor a, at::Tensor a_grad, const uint32_t B) {
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(a.scalar_type(), "matrix_to_raw_quaternion_bw", ([&] {
        kernel_matrix_to_raw_quaternion_bw<scalar_t>(out_grad.data_ptr<scalar_t>(), a.data_ptr<scalar_t>(), a_grad.data_ptr<scalar_t>(), B);
    }));
}
...
template <typename scalar_t>
void kernel_matrix_to_quaternion_fw(const scalar_t *__restrict__ a, scalar_t *__restrict__ out,
                                                 const uint32_t B) {
    for (uint32_t i = 0; i < B; i++) {
...
void matrix_to_quaternion_fw(at::Tensor a, at::Tensor out, const uint32_t B) {
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(a.scalar_type(), "matrix_to_quaternion_fw", ([&] {
        kernel_matrix_to_quaternion_fw<scalar_t>(a.data_ptr<scalar_t>(), out.data_ptr<scalar_t>(), B);
    }));
}
...
template <typename scalar_t>
void kernel_matrix_to_quaternion_bw(const scalar_t *__restrict__ out_grad, const scalar_t *__restrict__ a,
                                                 scalar_t *__restrict__ a_grad, const uint32_t B) {
    for (uint32_t i = 0; i < B; i++) {
...
void matrix_to_quaternion_bw(at::Tensor out_grad, at::Tensor a, at::Tensor a_grad, const uint32_t B) {
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(a.scalar_type(), "matrix_to_quaternion_bw", ([&] {
        kernel_matrix_to_quaternion_bw<scalar_t>(out_grad.data_ptr<scalar_t>(), a.data_ptr<scalar_t>(), a_grad.data_ptr<scalar_t>(), B);
    }));
}
...
template <typename scalar_t>
void kernel_axis_angle_to_quaternion_fw(const scalar_t *__restrict__ a, scalar_t *__restrict__ out,
                                                 const uint32_t B) {
    for (uint32_t i = 0; i < B; i++) {
...
void axis_angle_to_quaternion_fw(at::Tensor a, at::Tensor out, const uint32_t B) {
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(a.scalar_type(), "axis_angle_to_quaternion_fw", ([&] {
        kernel_axis_angle_to_quaternion_fw<scalar_t>(a.data_ptr<scalar_t>(), out.data_ptr<scalar_t>(), B);
    }));
}
...
template <typename scalar_t>
void kernel_axis_angle_to_quaternion_bw(const scalar_t *__restrict__ out_grad, const scalar_t *__restrict__ a,
                                                 scalar_t *__restrict__ a_grad, const uint32_t B) {
    for (uint32_t i = 0; i < B; i++) {
...
void axis_angle_to_quaternion_bw(at::Tensor out_grad, at::Tensor a, at::Tensor a_grad, const uint32_t B) {
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(a.scalar_type(), "axis_angle_to_quaternion_bw", ([&] {
        kernel_axis_angle_to_quaternion_bw<scalar_t>(out_grad.data_ptr<scalar_t>(), a.data_ptr<scalar_t>(), a_grad.data_ptr<scalar_t>(), B);
    }));
}
...
template <typename scalar_t>
void kernel_quaternion_to_axis_angle_fw(const scalar_t *__restrict__ a, scalar_t *__restrict__ out,
                                                 const uint32_t B) {
    for (uint32_t i = 0; i < B; i++) {
...
void quaternion_to_axis_angle_fw(at::Tensor a, at::Tensor out, const uint32_t B) {
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(a.scalar_type(), "quaternion_to_axis_angle_fw", ([&] {
        kernel_quaternion_to_axis_angle_fw<scalar_t>(a.data_ptr<scalar_t>(), out.data_ptr<scalar_t>(), B);
    }));
}
...
template <typename scalar_t>
void kernel_quaternion_to_axis_angle_bw(const scalar_t *__restrict__ out_grad, const scalar_t *__restrict__ a,
                                                 scalar_t *__restrict__ a_grad, const uint32_t B) {
    for (uint32_t i = 0; i < B; i++) {
...
void quaternion_to_axis_angle_bw(at::Tensor out_grad, at::Tensor a, at::Tensor a_grad, const uint32_t B) {
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(a.scalar_type(), "quaternion_to_axis_angle_bw", ([&] {
        kernel_quaternion_to_axis_angle_bw<scalar_t>(out_grad.data_ptr<scalar_t>(), a.data_ptr<scalar_t>(), a_grad.data_ptr<scalar_t>(), B);
    }));
}
...
template <typename scalar_t>
void kernel_axis_angle_to_matrix_fw(const scalar_t *__restrict__ a, scalar_t *__restrict__ out,
                                                 const uint32_t B) {
    for (uint32_t i = 0; i < B; i++) {
...
void axis_angle_to_matrix_fw(at::Tensor a, at::Tensor out, const uint32_t B) {
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(a.scalar_type(), "axis_angle_to_matrix_fw", ([&] {
        kernel_axis_angle_to_matrix_fw<scalar_t>(a.data_ptr<scalar_t>(), out.data_ptr<scalar_t>(), B);
    }));
}
...
template <typename scalar_t>
void kernel_axis_angle_to_matrix_bw(const scalar_t *__restrict__ out_grad, const scalar_t *__restrict__ a,
                                                 scalar_t *__restrict__ a_grad, const uint32_t B) {
    for (uint32_t i = 0; i < B; i++) {
...
void axis_angle_to_matrix_bw(at::Tensor out_grad, at::Tensor a, at::Tensor a_grad, const uint32_t B) {
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(a.scalar_type(), "axis_angle_to_matrix_bw", ([&] {
        kernel_axis_angle_to_matrix_bw<scalar_t>(out_grad.data_ptr<scalar_t>(), a.data_ptr<scalar_t>(), a_grad.data_ptr<scalar_t>(), B);
    }));
}
...
template <typename scalar_t>
void kernel_matrix_to_axis_angle_fw(const scalar_t *__restrict__ a, scalar_t *__restrict__ out,
                                                 const uint32_t B) {
    for (uint32_t i = 0; i < B; i++) {
...
void matrix_to_axis_angle_fw(at::Tensor a, at::Tensor out, const uint32_t B) {
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(a.scalar_type(), "matrix_to_axis_angle_fw", ([&] {
        kernel_matrix_to_axis_angle_fw<scalar_t>(a.data_ptr<scalar_t>(), out.data_ptr<scalar_t>(), B);
    }));
}
...
template <typename scalar_t>
void kernel_matrix_to_axis_angle_bw(const scalar_t *__restrict__ out_grad, const scalar_t *__restrict__ a,
                                                 scalar_t *__restrict__ a_grad, const uint32_t B) {
    for (uint32_t i = 0; i < B; i++) {
...
void matrix_to_axis_angle_bw(at::Tensor out_grad, at::Tensor a, at::Tensor a_grad, const uint32_t B) {
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(a.scalar_type(), "matrix_to_axis_angle_bw", ([&] {
        kernel_matrix_to_axis_angle_bw<scalar_t>(out_grad.data_ptr<scalar_t>(), a.data_ptr<scalar_t>(), a_grad.data_ptr<scalar_t>(), B);
    }));
}
...
template <typename scalar_t>
void kernel_quaternion_translation_mul_fw(const scalar_t *__restrict__ a_q, const scalar_t *__restrict__ a_t, const scalar_t *__restrict__ b_q, const scalar_t *__restrict__ b_t, scalar_t *__restrict__ out_q, scalar_t *__restrict__ out_t, const uint32_t B) {
    for (uint32_t i = 0; i < B; i++) {
...
void quaternion_translation_mul_fw(at::Tensor a_q, at::Tensor a_t, at::Tensor b_q, at::Tensor b_t, at::Tensor out_q, at::Tensor out_t, const uint32_t B) {
    CHECK_IS_CONTIGUOUS_FLOAT_CPU(a_q);
    CHECK_IS_CONTIGUOUS_FLOAT_CPU(a_t);
    CHECK_IS_CONTIGUOUS_FLOAT_CPU(b_q);
    CHECK_IS_CONTIGUOUS_FLOAT_CPU(b_t);
    CHECK_IS_CONTIGUOUS_FLOAT_CPU(out_q);
    CHECK_IS_CONTIGUOUS_FLOAT_CPU(out_t);

    AT_DISPATCH_FLOATING_TYPES_AND_HALF(a_q.scalar_type(), "quaternion_translation_mul_fw", ([&] {
        kernel_quaternion_translation_mul_fw<scalar_t>(a_q.data_ptr<scalar_t>(), a_t.data_ptr<scalar_t>(), b_q.data_ptr<scalar_t>(), b_t.data_ptr<scalar_t>(), out_q.data_ptr<scalar_t>(), out_t.data_ptr<scalar_t>(), B);
    }));
}
...
void quaternion_translation_mul_bw(at::Tensor out_q_grad, at::Tensor out_t_grad, at::Tensor a_q, at::Tensor a_t, at::Tensor b_q, at::Tensor b_t, at::Tensor a_q_grad, at::Tensor a_t_grad, at::Tensor b_q_grad, at::Tensor b_t_grad, const uint32_t B) {
    CHECK_IS_CONTIGUOUS_FLOAT_CPU(out_q_grad);
    CHECK_IS_CONTIGUOUS_FLOAT_CPU(out_t_grad);
    CHECK_IS_CONTIGUOUS_FLOAT_CPU(a_q);
    CHECK_IS_CONTIGUOUS_FLOAT_CPU(a_t);
    CHECK_IS_CONTIGUOUS_FLOAT_CPU(b_q);
    CHECK_IS_CONTIGUOUS_FLOAT_CPU(b_t);
    CHECK_IS_CONTIGUOUS_FLOAT_CPU(a_q_grad);
    CHECK_IS_CONTIGUOUS_FLOAT_CPU(a_t_grad);
    CHECK_IS_CONTIGUOUS_FLOAT_CPU(b_q_grad);
    CHECK_IS_CONTIGUOUS_FLOAT_CPU(b_t_grad);

    AT_DISPATCH_FLOATING_TYPES_AND_HALF(a_q.scalar_type(), "quaternion_translation_mul_bw", ([&] {
        kernel_quaternion_translation_mul_bw<scalar_t>(out_q_grad.data_ptr<scalar_t>(), out_t_grad.data_ptr<scalar_t>(), a_q.data_ptr<scalar_t>(), a_t.data_ptr<scalar_t>(), b_q.data_ptr<scalar_t>(), b_t.data_ptr<scalar_t>(), a_q_grad.data_ptr<scalar_t>(), a_t_grad.data_ptr<scalar_t>(), b_q_grad.data_ptr<scalar_t>(), b_t_grad.data_ptr<scalar_t>(), B);
    }));
}
...
template <typename scalar_t>
void kernel_quaternion_translation_apply_fw(const scalar_t *__restrict__ a_q, const scalar_t *__restrict__ a_t, const scalar_t *__restrict__ b, scalar_t *__restrict__ out, const uint32_t B) {
    for (uint32_t i = 0; i < B; i++) {
...
void quaternion_translation_apply_fw(at::Tensor a_q, at::Tensor a_t, at::Tensor b, at::Tensor out, const uint32_t B) {
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(a_q.scalar_type(), "quaternion_translation_apply_fw", ([&] {
        kernel_quaternion_translation_apply_fw<scalar_t>(a_q.data_ptr<scalar_t>(), a_t.data_ptr<scalar_t>(), b.data_ptr<scalar_t>(), out.data_ptr<scalar_t>(), B);
    }));
}
...
template <typename scalar_t>
void kernel_quaternion_translation_apply_bw(const scalar_t *__restrict__ out_grad, const scalar_t *__restrict__ a_q, const scalar_t *__restrict__ a_t, const scalar_t *__restrict__ b, scalar_t *__restrict__ a_q_grad, scalar_t *__restrict__ a_t_grad, scalar_t *__restrict__ b_grad, const uint32_t B) {
    for (uint32_t i = 0; i < B; i++) {
...
void quaternion_translation_apply_bw(at::Tensor out_grad, at::Tensor a_q, at::Tensor a_t, at::Tensor b, at::Tensor a_q_grad, at::Tensor a_t_grad, at::Tensor b_grad, const uint32_t B) {
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(a_q.scalar_type(), "quaternion_translation_apply_bw", ([&] {
        kernel_quaternion_translation_apply_bw<scalar_t>(out_grad.data_ptr<scalar_t>(), a_q.data_ptr<scalar_t>(), a_t.data_ptr<scalar_t>(), b.data_ptr<scalar_t>(), a_q_grad.data_ptr<scalar_t>(), a_t_grad.data_ptr<scalar_t>(), b_grad.data_ptr<scalar_t>(), B);
    }));
}
...
template <typename scalar_t>
void kernel_quaternion_translation_inverse_fw(const scalar_t *__restrict__ a_q, const scalar_t *__restrict__ a_t, scalar_t *__restrict__ out_q, scalar_t *__restrict__ out_t, const uint32_t B) {
    for (uint32_t i = 0; i < B; i++) {
...
void quaternion_translation_inverse_fw(at::Tensor a_q, at::Tensor a_t, at::Tensor out_q, at::Tensor out_t, const uint32_t B) {
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(a_q.scalar_type(), "quaternion_translation_inverse_fw", ([&] {
        kernel_quaternion_translation_inverse_fw<scalar_t>(a_q.data_ptr<scalar_t>(), a_t.data_ptr<scalar_t>(), out_q.data_ptr<scalar_t>(), out_t.data_ptr<scalar_t>(), B);
    }));
}
...
template <typename scalar_t>
void kernel_quaternion_translation_inverse_bw(const scalar_t *__restrict__ out_q_grad, const scalar_t *__restrict__ out_t_grad, const scalar_t *__restrict__ a_q, const scalar_t *__restrict__ a_t, scalar_t *__restrict__ a_q_grad, scalar_t *__restrict__ a_t_grad, const uint32_t B) {
    for (uint32_t i = 0; i < B; i++) {
...
void quaternion_translation_inverse_bw(at::Tensor out_q_grad, at::Tensor out_t_grad, at::Tensor a_q, at::Tensor a_t, at::Tensor a_q_grad, at::Tensor a_t_grad, const uint32_t B) {
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(a_q.scalar_type(), "quaternion_translation_inverse_bw", ([&] {
        kernel_quaternion_translation_inverse_bw<scalar_t>(out_q_grad.data_ptr<scalar_t>(), out_t_grad.data_ptr<scalar_t>(), a_q.data_ptr<scalar_t>(), a_t.data_ptr<scalar_t>(), a_q_grad.data_ptr<scalar_t>(), a_t_grad.data_ptr<scalar_t>(), B);
    }));
}
...
template <typename scalar_t>
void kernel_dual_quaternion_mul_fw(const scalar_t *__restrict__ a_r, const scalar_t *__restrict__ a_d, const scalar_t *__restrict__ b_r, const scalar_t *__restrict__ b_d, scalar_t *__restrict__ out_r, scalar_t *__restrict__ out_d, const uint32_t B) {
    for (uint32_t i = 0; i < B; i++) {
...
void dual_quaternion_mul_fw(at::Tensor a_r, at::Tensor a_d, at::Tensor b_r, at::Tensor b_d, at::Tensor out_r, at::Tensor out_d, const uint32_t B) {
    CHECK_IS_CONTIGUOUS_FLOAT_CPU(a_r);
    CHECK_IS_CONTIGUOUS_FLOAT_CPU(a_d);
    CHECK_IS_CONTIGUOUS_FLOAT_CPU(b_r);
    CHECK_IS_CONTIGUOUS_FLOAT_CPU(b_d);
    CHECK_IS_CONTIGUOUS_FLOAT_CPU(out_r);
    CHECK_IS_CONTIGUOUS_FLOAT_CPU(out_d);

    AT_DISPATCH_FLOATING_TYPES_AND_HALF(a_r.scalar_type(), "dual_quaternion_mul_fw", ([&] {
        kernel_dual_quaternion_mul_fw<scalar_t>(a_r.data_ptr<scalar_t>(), a_d.data_ptr<scalar_t>(), b_r.data_ptr<scalar_t>(), b_d.data_ptr<scalar_t>(), out_r.data_ptr<scalar_t>(), out_d.data_ptr<scalar_t>(), B);
    }));
}
...
void dual_quaternion_mul_bw(at::Tensor out_r_grad, at::Tensor out_d_grad, at::Tensor a_r, at::Tensor a_d, at::Tensor b_r, at::Tensor b_d, at::Tensor a_r_grad, at::Tensor a_d_grad, at::Tensor b_r_grad, at::Tensor b_d_grad, const uint32_t B) {
    CHECK_IS_CONTIGUOUS_FLOAT_CPU(out_r_grad);
    CHECK_IS_CONTIGUOUS_FLOAT_CPU(out_d_grad);
    CHECK_IS_CONTIGUOUS_FLOAT_CPU(a_r);
    CHECK_IS_CONTIGUOUS_FLOAT_CPU(a_d);
    CHECK_IS_CONTIGUOUS_FLOAT_CPU(b_r);
    CHECK_IS_CONTIGUOUS_FLOAT_CPU(b_d);
    CHECK_IS_CONTIGUOUS_FLOAT_CPU(a_r_grad);
    CHECK_IS_CONTIGUOUS_FLOAT_CPU(a_d_grad);
    CHECK_IS_CONTIGUOUS_FLOAT_CPU(b_r_grad);
    CHECK_IS_CONTIGUOUS_FLOAT_CPU(b_d_grad);

    AT_DISPATCH_FLOATING_TYPES_AND_HALF(a_r.scalar_type(), "dual_quaternion_mul_bw", ([&] {
        kernel_dual_quaternion_mul_bw<scalar_t>(out_r_grad.data_ptr<scalar_t>(), out_d_grad.data_ptr<scalar_t>(), a_r.data_ptr<scalar_t>(), a_d.data_ptr<scalar_t>(), b_r.data_ptr<scalar_t>(), b_d.data_ptr<scalar_t>(), a_r_grad.data_ptr<scalar_t>(), a_d_grad.data_ptr<scalar_t>(), b_r_grad.data_ptr<scalar_t>(), b_d_grad.data_ptr<scalar_t>(), B);
    }));
}
...
template <typename scalar_t>
void kernel_dual_quaternion_apply_fw(const scalar_t *__restrict__ a_r, const scalar_t *__restrict__ a_d, const scalar_t *__restrict__ b, scalar_t *__restrict__ out, const uint32_t B) {
    for (uint32_t i = 0; i < B; i++) {
...
void dual_quaternion_apply_fw(at::Tensor a_r, at::Tensor a_d, at::Tensor b, at::Tensor out, const uint32_t B) {
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(a_r.scalar_type(), "dual_quaternion_apply_fw", ([&] {
        kernel_dual_quaternion_apply_fw<scalar_t>(a_r.data_ptr<scalar_t>(), a_d.data_ptr<scalar_t>(), b.data_ptr<scalar_t>(), out.data_ptr<scalar_t>(), B);
    }));
}
...
template <typename scalar_t>
void kernel_dual_quaternion_apply_bw(const scalar_t *__restrict__ out_grad, const scalar_t *__restrict__ a_r, const scalar_t *__restrict__ a_d, const scalar_t *__restrict__ b, scalar_t *__restrict__ a_r_grad, scalar_t *__restrict__ a_d_grad, scalar_t *__restrict__ b_grad, const uint32_t B) {
    for (uint32_t i = 0; i < B; i++) {
...
void dual_quaternion_apply_bw(at::Tensor out_grad, at::Tensor a_r, at::Tensor a_d, at::Tensor b, at::Tensor a_r_grad, at::Tensor a_d_grad, at::Tensor b_grad, const uint32_t B) {
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(a_r.scalar_type(), "dual_quaternion_apply_bw", ([&] {
        kernel_dual_quaternion_apply_bw<scalar_t>(out_grad.data_ptr<scalar_t>(), a_r.data_ptr<scalar_t>(), a_d.data_ptr<scalar_t>(), b.data_ptr<scalar_t>(), a_r_grad.data_ptr<scalar_t>(), a_d_grad.data_ptr<scalar_t>(), b_grad.data_ptr<scalar_t>(), B);
    }));
}
...
template <typename scalar_t>
void kernel_dual_quaternion_q_conjugate_fw(const scalar_t *__restrict__ a_r, const scalar_t *__restrict__ a_d, scalar_t *__restrict__ out_r, scalar_t *__restrict__ out_d, const uint32_t B) {
    for (uint32_t i = 0; i < B; i++) {
...
void dual_quaternion_q_conjugate_fw(at::Tensor a_r, at::Tensor a_d, at::Tensor out_r, at::Tensor out_d, const uint32_t B) {
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(a_r.scalar_type(), "dual_quaternion_q_conjugate_fw", ([&] {
        kernel_dual_quaternion_q_conjugate_fw<scalar_t>(a_r.data_ptr<scalar_t>(), a_d.data_ptr<scalar_t>(), out_r.data_ptr<scalar_t>(), out_d.data_ptr<scalar_t>(), B);
    }));
}
...
template <typename scalar_t>
void kernel_dual_quaternion_q_conjugate_bw(const scalar_t *__restrict__ out_r_grad, const scalar_t *__restrict__ out_d_grad, const scalar_t *__restrict__ a_r, const scalar_t *__restrict__ a_d, scalar_t *__restrict__ a_r_grad, scalar_t *__restrict__ a_d_grad, const uint32_t B) {
    for (uint32_t i = 0; i < B; i++) {
...
void dual_quaternion_q_conjugate_bw(at::Tensor out_r_grad, at::Tensor out_d_grad, at::Tensor a_r, at::Tensor a_d, at::Tensor a_r_grad, at::Tensor a_d_grad, const uint32_t B) {
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(a_r.scalar_type(), "dual_quaternion_q_conjugate_bw", ([&] {
        kernel_dual_quaternion_q_conjugate_bw<scalar_t>(out_r_grad.data_ptr<scalar_t>(), out_d_grad.data_ptr<scalar_t>(), a_r.data_ptr<scalar_t>(), a_d.data_ptr<scalar_t>(), a_r_grad.data_ptr<scalar_t>(), a_d_grad.data_ptr<scalar_t>(), B);
    }));
}
...
template <typename scalar_t>
void kernel_dual_quaternion_d_conjugate_fw(const scalar_t *__restrict__ a_r, const scalar_t *__restrict__ a_d, scalar_t *__restrict__ out_r, scalar_t *__restrict__ out_d, const uint32_t B) {
    for (uint32_t i = 0; i < B; i++) {
...
void dual_quaternion_d_conjugate_fw(at::Tensor a_r, at::Tensor a_d, at::Tensor out_r, at::Tensor out_d, const uint32_t B) {
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(a_r.scalar_type(), "dual_quaternion_d_conjugate_fw", ([&] {
        kernel_dual_quaternion_d_conjugate_fw<scalar_t>(a_r.data_ptr<scalar_t>(), a_d.data_ptr<scalar_t>(), out_r.data_ptr<scalar_t>(), out_d.data_ptr<scalar_t>(), B);
    }));
}
...
template <typename scalar_t>
void kernel_dual_quaternion_d_conjugate_bw(const scalar_t *__restrict__ out_r_grad, const scalar_t *__restrict__ out_d_grad, const scalar_t *__restrict__ a_r, const scalar_t *__restrict__ a_d, scalar_t *__restrict__ a_r_grad, scalar_t *__restrict__ a_d_grad, const uint32_t B) {
    for (uint32_t i = 0; i < B; i++) {
...
void dual_quaternion_d_conjugate_bw(at::Tensor out_r_grad, at::Tensor out_d_grad, at::Tensor a_r, at::Tensor a_d, at::Tensor a_r_grad, at::Tensor a_d_grad, const uint32_t B) {
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(a_r.scalar_type(), "dual_quaternion_d_conjugate_bw", ([&] {
        kernel_dual_quaternion_d_conjugate_bw<scalar_t>(out_r_grad.data_ptr<scalar_t>(), out_d_grad.data_ptr<scalar_t>(), a_r.data_ptr<scalar_t>(), a_d.data_ptr<scalar_t>(), a_r_grad.data_ptr<scalar_t>(), a_d_grad.data_ptr<scalar_t>(), B);
    }));
}
...
template <typename scalar_t>
void kernel_dual_quaternion_3rd_conjugate_fw(const scalar_t *__restrict__ a_r, const scalar_t *__restrict__ a_d, scalar_t *__restrict__ out_r, scalar_t *__restrict__ out_d, const uint32_t B) {
    for (uint32_t i = 0; i < B; i++) {
...
void dual_quaternion_3rd_conjugate_fw(at::Tensor a_r, at::Tensor a_d, at::Tensor out_r, at::Tensor out_d, const uint32_t B) {
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(a_r.scalar_type(), "dual_quaternion_3rd_conjugate_fw", ([&] {
        kernel_dual_quaternion_3rd_conjugate_fw<scalar_t>(a_r.data_ptr<scalar_t>(), a_d.data_ptr<scalar_t>(), out_r.data_ptr<scalar_t>(), out_d.data_ptr<scalar_t>(), B);
    }));
}
...
template <typename scalar_t>
void kernel_dual_quaternion_3rd_conjugate_bw(const scalar_t *__restrict__ out_r_grad, const scalar_t *__restrict__ out_d_grad, const scalar_t *__restrict__ a_r, const scalar_t *__restrict__ a_d, scalar_t *__restrict__ a_r_grad, scalar_t *__restrict__ a_d_grad, const uint32_t B) {
    for (uint32_t i = 0; i < B; i++) {
...
void dual_quaternion_3rd_conjugate_bw(at::Tensor out_r_grad, at::Tensor out_d_grad, at::Tensor a_r, at::Tensor a_d, at::Tensor a_r_grad, at::Tensor a_d_grad, const uint32_t B) {
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(a_r.scalar_type(), "dual_quaternion_3rd_conjugate_bw", ([&] {
        kernel_dual_quaternion_3rd_conjugate_bw<scalar_t>(out_r_grad.data_ptr<scalar_t>(), out_d_grad.data_ptr<scalar_t>(), a_r.data_ptr<scalar_t>(), a_d.data_ptr<scalar_t>(), a_r_grad.data_ptr<scalar_t>(), a_d_grad.data_ptr<scalar_t>(), B);
    }));
}
...
template <typename scalar_t>
void kernel_dual_quaternion_norm_fw(const scalar_t *__restrict__ a_r, const scalar_t *__restrict__ a_d, scalar_t *__restrict__ out_r, scalar_t *__restrict__ out_d, const uint32_t B) {
    for (uint32_t i = 0; i < B; i++) {
...
void dual_quaternion_norm_fw(at::Tensor a_r, at::Tensor a_d, at::Tensor out_r, at::Tensor out_d, const uint32_t B) {
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(a_r.scalar_type(), "dual_quaternion_norm_fw", ([&] {
        kernel_dual_quaternion_norm_fw<scalar_t>(a_r.data_ptr<scalar_t>(), a_d.data_ptr<scalar_t>(), out_r.data_ptr<scalar_t>(), out_d.data_ptr<scalar_t>(), B);
    }));
}
...
template <typename scalar_t>
void kernel_dual_quaternion_norm_bw(const scalar_t *__restrict__ out_r_grad, const scalar_t *__restrict__ out_d_grad, const scalar_t *__restrict__ a_r, const scalar_t *__restrict__ a_d, scalar_t *__restrict__ a_r_grad, scalar_t *__restrict__ a_d_grad, const uint32_t B) {
    for (uint32_t i = 0; i < B; i++) {
...
void dual_quaternion_norm_bw(at::Tensor out_r_grad, at::Tensor out_d_grad, at::Tensor a_r, at::Tensor a_d, at::Tensor a_r_grad, at::Tensor a_d_grad, const uint32_t B) {
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(a_r.scalar_type(), "dual_quaternion_norm_bw", ([&] {
        kernel_dual_quaternion_norm_bw<scalar_t>(out_r_grad.data_ptr<scalar_t>(), out_d_grad.data_ptr<scalar_t>(), a_r.data_ptr<scalar_t>(), a_d.data_ptr<scalar_t>(), a_r_grad.data_ptr<scalar_t>(), a_d_grad.data_ptr<scalar_t>(), B);
    }));
}
...
template <typename scalar_t>
void kernel_quaternion_translation_to_dual_quaternion_fw(const scalar_t *__restrict__ a_q, const scalar_t *__restrict__ a_t, scalar_t *__restrict__ out_r, scalar_t *__restrict__ out_d, const uint32_t B) {
    for (uint32_t i = 0; i < B; i++) {
...
void quaternion_translation_to_dual_quaternion_fw(at::Tensor a_q, at::Tensor a_t, at::Tensor out_r, at::Tensor out_d, const uint32_t B) {
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(a_q.scalar_type(), "quaternion_translation_to_dual_quaternion_fw", ([&] {
        kernel_quaternion_translation_to_dual_quaternion_fw<scalar_t>(a_q.data_ptr<scalar_t>(), a_t.data_ptr<scalar_t>(), out_r.data_ptr<scalar_t>(), out_d.data_ptr<scalar_t>(), B);
    }));
}
...
template <typename scalar_t>
void kernel_quaternion_translation_to_dual_quaternion_bw(const scalar_t *__restrict__ out_r_grad, const scalar_t *__restrict__ out_d_grad, const scalar_t *__restrict__ a_q, const scalar_t *__restrict__ a_t, scalar_t *__restrict__ a_q_grad, scalar_t *__restrict__ a_t_grad, const uint32_t B) {
    for (uint32_t i = 0; i < B; i++) {
...
void quaternion_translation_to_dual_quaternion_bw(at::Tensor out_r_grad, at::Tensor out_d_grad, at::Tensor a_q, at::Tensor a_t, at::Tensor a_q_grad, at::Tensor a_t_grad, const uint32_t B) {
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(a_q.scalar_type(), "quaternion_translation_to_dual_quaternion_bw", ([&] {
        kernel_quaternion_translation_to_dual_quaternion_bw<scalar_t>(out_r_grad.data_ptr<scalar_t>(), out_d_grad.data_ptr<scalar_t>(), a_q.data_ptr<scalar_t>(), a_t.data_ptr<scalar_t>(), a_q_grad.data_ptr<scalar_t>(), a_t_grad.data_ptr<scalar_t>(), B);
    }));
}
...
template <typename scalar_t>
void kernel_dual_quaternion_to_quaternion_translation_fw(const scalar_t *__restrict__ a_r, const scalar_t *__restrict__ a_d, scalar_t *__restrict__ out_q, scalar_t *__restrict__ out_t, const uint32_t B) {
    for (uint32_t i = 0; i < B; i++) {
...
void dual_quaternion_to_quaternion_translation_fw(at::Tensor a_r, at::Tensor a_d, at::Tensor out_q, at::Tensor out_t, const uint32_t B) {
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(a_r.scalar_type(), "dual_quaternion_to_quaternion_translation_fw", ([&] {
        kernel_dual_quaternion_to_quaternion_translation_fw<scalar_t>(a_r.data_ptr<scalar_t>(), a_d.data_ptr<scalar_t>(), out_q.data_ptr<scalar_t>(), out_t.data_ptr<scalar_t>(), B);
    }));
}
...
template <typename scalar_t>
void kernel_dual_quaternion_to_quaternion_translation_bw(const scalar_t *__restrict__ out_q_grad, const scalar_t *__restrict__ out_t_grad, const scalar_t *__restrict__ a_r, const scalar_t *__restrict__ a_d, scalar_t *__restrict__ a_r_grad, scalar_t *__restrict__ a_d_grad, const uint32_t B) {
    for (uint32_t i = 0; i < B; i++) {
...
void dual_quaternion_to_quaternion_translation_bw(at::Tensor out_q_grad, at::Tensor out_t_grad, at::Tensor a_r, at::Tensor a_d, at::Tensor a_r_grad, at::Tensor a_d_grad, const uint32_t B) {
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(a_r.scalar_type(), "dual_quaternion_to_quaternion_translation_bw", ([&] {
        kernel_dual_quaternion_to_quaternion_translation_bw<scalar_t>(out_q_grad.data_ptr<scalar_t>(), out_t_grad.data_ptr<scalar_t>(), a_r.data_ptr<scalar_t>(), a_d.data_ptr<scalar_t>(), a_r_grad.data_ptr<scalar_t>(), a_d_grad.data_ptr<scalar_t>(), B);
    }));
}
...
template <typename scalar_t>
void kernel_quaternion_translation_to_se3_fw(const scalar_t *__restrict__ a_q, const scalar_t *__restrict__ a_t, scalar_t *__restrict__ out, const uint32_t B) {
    for (uint32_t i = 0; i < B; i++) {
...
void quaternion_translation_to_se3_fw(at::Tensor a_q, at::Tensor a_t, at::Tensor out, const uint32_t B) {
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(a_q.scalar_type(), "quaternion_translation_to_se3_fw", ([&] {
        kernel_quaternion_translation_to_se3_fw<scalar_t>(a_q.data_ptr<scalar_t>(), a_t.data_ptr<scalar_t>(), out.data_ptr<scalar_t>(), B);
    }));
}
...
template <typename scalar_t>
void kernel_quaternion_translation_to_se3_bw(const scalar_t *__restrict__ out_grad, const scalar_t *__restrict__ a_q, const scalar_t *__restrict__ a_t, scalar_t *__restrict__ a_q_grad, scalar_t *__restrict__ a_t_grad, const uint32_t B) {
    for (uint32_t i = 0; i < B; i++) {
...
void quaternion_translation_to_se3_bw(at::Tensor out_grad, at::Tensor a_q, at::Tensor a_t, at::Tensor a_q_grad, at::Tensor a_t_grad, const uint32_t B) {
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(a_q.scalar_type(), "quaternion_translation_to_se3_bw", ([&] {
        kernel_quaternion_translation_to_se3_bw<scalar_t>(out_grad.data_ptr<scalar_t>(), a_q.data_ptr<scalar_t>(), a_t.data_ptr<scalar_t>(), a_q_grad.data_ptr<scalar_t>(), a_t_grad.data_ptr<scalar_t>(), B);
    }));
}
...
template <typename scalar_t>
void kernel_se3_to_quaternion_translation_fw(const scalar_t *__restrict__ a, scalar_t *__restrict__ out_q, scalar_t *__restrict__ out_t, const uint32_t B) {
    for (uint32_t i = 0; i < B; i++) {
...
void se3_to_quaternion_translation_fw(at::Tensor a, at::Tensor out_q, at::Tensor out_t, const uint32_t B) {
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(a.scalar_type(), "se3_to_quaternion_translation_fw", ([&] {
        kernel_se3_to_quaternion_translation_fw<scalar_t>(a.data_ptr<scalar_t>(), out_q.data_ptr<scalar_t>(), out_t.data_ptr<scalar_t>(), B);
    }));
}
...
template <typename scalar_t>
void kernel_se3_to_quaternion_translation_bw(const scalar_t *__restrict__ out_q_grad, const scalar_t *__restrict__ out_t_grad, const scalar_t *__restrict__ a, scalar_t *__restrict__ a_grad, const uint32_t B) {
    for (uint32_t i = 0; i < B; i++) {
...
void se3_to_quaternion_translation_bw(at::Tensor out_q_grad, at::Tensor out_t_grad, at::Tensor a, at::Tensor a_grad, const uint32_t B) {
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(a.scalar_type(), "se3_to_quaternion_translation_bw", ([&] {
        kernel_se3_to_quaternion_translation_bw<scalar_t>(out_q_grad.data_ptr<scalar_t>(), out_t_grad.data_ptr<scalar_t>(), a.data_ptr<scalar_t>(), a_grad.data_ptr<scalar_t>(), B);
    }));
}
...
template <typename scalar_t>
void kernel_dual_quaternion_to_se3_fw(const scalar_t *__restrict__ a_r, const scalar_t *__restrict__ a_d, scalar_t *__restrict__ out, const uint32_t B) {
    for (uint32_t i = 0; i < B; i++) {
...
void dual_quaternion_to_se3_fw(at::Tensor a_r, at::Tensor a_d, at::Tensor out, const uint32_t B) {
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(a_r.scalar_type(), "dual_quaternion_to_se3_fw", ([&] {
        kernel_dual_quaternion_to_se3_fw<scalar_t>(a_r.data_ptr<scalar_t>(), a_d.data_ptr<scalar_t>(), out.data_ptr<scalar_t>(), B);
    }));
}
...
template <typename scalar_t>
void kernel_dual_quaternion_to_se3_bw(const scalar_t *__restrict__ out_grad, const scalar_t *__restrict__ a_r, const scalar_t *__restrict__ a_d, scalar_t *__restrict__ a_r_grad, scalar_t *__restrict__ a_d_grad, const uint32_t B) {
    for (uint32_t i = 0; i < B; i++) {
...
void dual_quaternion_to_se3_bw(at::Tensor out_grad, at::Tensor a_r, at::Tensor a_d, at::Tensor a_r_grad, at::Tensor a_d_grad, const uint32_t B) {
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(a_r.scalar_type(), "dual_quaternion_to_se3_bw", ([&] {
        kernel_dual_quaternion_to_se3_bw<scalar_t>(out_grad.data_ptr<scalar_t>(), a_r.data_ptr<scalar_t>(), a_d.data_ptr<scalar_t>(), a_r_grad.data_ptr<scalar_t>(), a_d_grad.data_ptr<scalar_t>(), B);
    }));
}
...
template <typename scalar_t>
void kernel_se3_to_dual_quaternion_fw(const scalar_t *__restrict__ a, scalar_t *__restrict__ out_r, scalar_t *__restrict__ out_d, const uint32_t B) {
    for (uint32_t i = 0; i < B; i++) {
...
void se3_to_dual_quaternion_fw(at::Tensor a, at::Tensor out_r, at::Tensor out_d, const uint32_t B) {
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(a.scalar_type(), "se3_to_dual_quaternion_fw", ([&] {
        kernel_se3_to_dual_quaternion_fw<scalar_t>(a.data_ptr<scalar_t>(), out_r.data_ptr<scalar_t>(), out_d.data_ptr<scalar_t>(), B);
    }));
}
...
template <typename scalar_t>
void kernel_se3_to_dual_quaternion_bw(const scalar_t *__restrict__ out_r_grad, const scalar_t *__restrict__ out_d_grad, const scalar_t *__restrict__ a, scalar_t *__restrict__ a_grad, const uint32_t B) {
    for (uint32_t i = 0; i < B; i++) {
...
void se3_to_dual_quaternion_bw(at::Tensor out_r_grad, at::Tensor out_d_grad, at::Tensor a, at::Tensor a_grad, const uint32_t B) {
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(a.scalar_type(), "se3_to_dual_quaternion_bw", ([&] {
        kernel_se3_to_dual_quaternion_bw<scalar_t>(out_r_grad.data_ptr<scalar_t>(), out_d_grad.data_ptr<scalar_t>(), a.data_ptr<scalar_t>(), a_grad.data_ptr<scalar_t>(), B);
    }));
}
