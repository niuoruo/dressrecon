...
class GSplatConfig:
    ...
    flags.DEFINE_integer("num_pts", 40000, "number of 3D Gaussians")
    ...
    flags.DEFINE_integer("first_fr_steps", 2000, "steps for optimizing first frame in incremental mode")
